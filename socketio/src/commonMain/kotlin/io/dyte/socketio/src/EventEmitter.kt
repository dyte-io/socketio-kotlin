...
open class EventEmitter {
  ...
  fun on(event: String, handler: (data: Any?) -> Unit) {
    this._events.getOrPut(event , fun (): MutableList<(data: Any?) -> Unit> { return mutableListOf<(data: Any?) -> Unit>() })
  ...
  fun once(event: String, handler: (data: Any?) -> Unit) {
    this._eventsOnce.getOrPut(event , fun (): MutableList<(data: Any?) -> Unit> { return mutableListOf<(data: Any?) -> Unit>() })
